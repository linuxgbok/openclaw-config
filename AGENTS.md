...
2. 按优先级只问最关键的3-7个问题
3. 主动想到可能遗漏的：目标/用户/场景/输入输出/成功标准/时间预算/技术限制/风险边界/必须vs可选
...
### 参考风格
- 飞书文档：OpenClaw安装教程（NC3IdNnyVoboEGx7lNBcBeK2nYb）
- 飞书文档：baoyu-skills安装指南（YEJEdSJAIo2z2zxJ0iqc7bEdn0e）
...
### 通用结构
📦概述/安装状态 → 📁目录/位置 → 🔧使用方法 → ⚙️配置要求 → 🚀快速开始 → 📝详情 → 🔍验证 → 🛠️故障排除 → 📚资源 → 🎯下一步
